...
{
    public class SaoPauloVisitor(string visitorName) : Class::Visitor(visitorName)
    {
        ...
        {
            var imposto = (produtoNaoPerecivel.PesoProduto / 100) + _impostoNaoPerecivel;
        ...
        {
            var imposto = (produtoPerecivel.PesoProduto / 100) + _impostoPerecivel;
